...
Public Class tdionysius2f1
        ...
        Integer.TryParse(Me.txtRooms.Text, intRoomsReserved)
        Integer.TryParse(Me.txtNights.Text, intNights)
        Integer.TryParse(Me.txtAdults.Text, intAdults)
        Integer.TryParse(Me.txtChildren.Text, intChildren)
        ...
        If intRoomsReserved < dblRoomsRequired Then
            MessageBox.Show(strMSG, "tdionysius2f1",
